...
export const buttonLikeClass = cva({
  ...
  variants: {
    ...
    height: {
      "2x": { rounded: "0x", minW: "2x" },
      "3": { rounded: "0x", minW: "3" },
      "3x": { rounded: "0x", minW: "3x" },
      "4": { rounded: "1_x", minW: "4" },
      "4x": { rounded: "1_x", minW: "4x" },
      "5": { rounded: "1_x", minW: "5" },
      "5x": { rounded: "1_x", minW: "5x" },
      "6": { rounded: "1_x", minW: "6" },
      "6x": { rounded: "1_x", minW: "6x" },
      "7": { rounded: "1_x", minW: "7" },
      "7x": { rounded: "1_x", minW: "7x" },
      "8": { rounded: "1_x", minW: "8" },
      "9": { rounded: "1_x", minW: "9" },
      "10": { rounded: "1_x", minW: "10" },
      "12": { rounded: "1_x", minW: "12" },
