...
export function buttonClassName({
  ...
  const variantClass = pick(variant, {
    ...
    secondary: cn(
      ...
      interactive &&
        tw`hover:bg-dynamic-600 hover:text-white ring-dynamic-500/50`,
    ...
    tertiary: cn(
      ...
      interactive &&
        tw`hover:bg-white/5 hover:text-dynamic-300 ring-dynamic-500/50`,
    ...
    outline: cn(
      ...
      interactive &&
        tw`aria-disabled:text-dynamic-200/40 aria-disabled:ring-white/50`
    ),
  });
